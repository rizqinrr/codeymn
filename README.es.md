...
npm i -g Codeymn-ai@latest        # o bun/pnpm/yarn
scoop install Codeymn             # Windows
choco install Codeymn             # Windows
brew install anomalyco/tap/Codeymn # macOS y Linux (recomendado, siempre al día)
brew install Codeymn              # macOS y Linux (fórmula oficial de brew, se actualiza menos)
sudo pacman -S Codeymn            # Arch Linux (Stable)
paru -S Codeymn-bin               # Arch Linux (Latest from AUR)
mise use -g Codeymn               # cualquier sistema
nix run nixpkgs#Codeymn           # o github:anomalyco/Codeymn para la rama dev más reciente
```
...
Codeymn también está disponible como aplicación de escritorio. Descárgala directamente desde la [página de releases](https://github.com/anomalyco/Codeymn/releases) o desde [Codeymn.ai/download](https://Codeymn.ai/download).
...
1. `$CODEYMN_INSTALL_DIR` - Directorio de instalación personalizado
2. `$XDG_BIN_DIR` - Ruta compatible con la especificación XDG Base Directory
3. `$HOME/bin` - Directorio binario estándar del usuario (si existe o se puede crear)
4. `$HOME/.Codeymn/bin` - Alternativa por defecto
...
Codeymn incluye dos agentes integrados que puedes alternar con la tecla `Tab`.
...
Más información sobre [agentes](https://Codeymn.ai/docs/agents).

### Documentación

Para más información sobre cómo configurar Codeymn, [**ve a nuestra documentación**](https://Codeymn.ai/docs).

### Contribuir

Si te interesa contribuir a Codeymn, lee nuestras [docs de contribución](./CONTRIBUTING.md) antes de enviar un pull request.

### Proyectos basados en Codeymn

Si estás trabajando en un proyecto basado en Codeymn y usas "Codeymn" como parte del nombre, por ejemplo, "Codeymn-dashboard" u "Codeymn-mobile", agrega una nota en tu README para aclarar que no está hecho por el equipo de Codeymn y que no está afiliado con nosotros de ninguna manera.

---

**Únete a nuestra comunidad** [Discord](https://discord.gg/Codeymn) | [X.com](https://x.com/Codeymn)
