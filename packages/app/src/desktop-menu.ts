...
export const DESKTOP_MENU: DesktopMenu[] = [
  ...
  },
  {
    ...
    label: "Help",
    items: [
      { type: "item", label: "Codeymn Documentation", href: "" },
      ...
      { type: "separator" },
      {
        ...
        href: "https://github.com/rizqinrr/codeymn/issues/new?template=feature_request.yml",
      },
      {
        type: "item",
        label: "Report a Bug",
        href: "https://github.com/rizqinrr/codeymn/issues/new?template=bug_report.yml",
      },
    ],
  },
]
