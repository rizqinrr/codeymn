export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "نماذج مجانية مقدمة من Codeymn",
  ...
  "provider.connect.apiKey.description":
    "أدخل مفتاح واجهة برمجة تطبيقات {{provider}} الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في Codeymn.",
  ...
  "provider.connect.opencodeZen.line1":
    "يمنحك Codeymn Zen الوصول إلى مجموعة مختارة من النماذج الموثوقة والمحسنة لوكلاء البرمجة.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " للحصول على رمز التفويض الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في Codeymn.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " وأدخل الرمز أدناه لتوصيل حسابك واستخدام نماذج {{provider}} في Codeymn.",
  ...
  "dialog.server.description": "تبديل خادم Codeymn الذي يتصل به هذا التطبيق.",
  ...
  "wsl.onboarding.checkingOpencode": "جارٍ التحقق من Codeymn...",
  "wsl.onboarding.checkingOpencodeIn": "جارٍ التحقق من Codeymn في {{distro}}...",
  "wsl.onboarding.updatingOpencode": "جارٍ تحديث Codeymn...",
  "wsl.onboarding.updatingOpencodeIn": "جارٍ تحديث Codeymn في {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "حدّث Codeymn في {{distro}}.",
  "wsl.onboarding.updateOpencode": "تحديث Codeymn",
  "wsl.onboarding.opencodeReadyIn": "Codeymn جاهز في {{distro}}.",
  "wsl.onboarding.opencodeReady": "Codeymn جاهز.",
  "wsl.onboarding.installOpencodeIn": "ثبّت Codeymn في {{distro}}.",
  "wsl.onboarding.installOpencode": "تثبيت Codeymn",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Codeymn غير مثبت",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "يلزم WSL (نظام Windows الفرعي لـ Linux) قبل أن يتمكن Codeymn من إضافة خادم WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL غير متاح",
  "wsl.onboarding.wslUnavailable.description": "تعذر على Codeymn التحقق من WSL على هذا الجهاز.",
  "wsl.onboarding.installWsl": "تثبيت WSL",
  "wsl.onboarding.windowsRestartRequired": "أعد تشغيل Windows لإكمال تثبيت WSL، ثم أعد فتح Codeymn.",
  ...
  "toast.update.description": "نسخة جديدة من Codeymn ({{version}}) متاحة الآن للتثبيت.",
  ...
  "error.page.report.prefix": "يرجى الإبلاغ عن هذا الخطأ لفريق Codeymn",
  ...
  "error.chain.mcpFailed": 'فشل خادم MCP "{{name}}". لاحظ أن Codeymn لا يدعم مصادقة MCP بعد.',
  ...
  "sidebar.gettingStarted.line1": "يتضمن Codeymn نماذج مجانية حتى تتمكن من البدء فورًا.",
  ...
  "settings.desktop.wsl.description": "تشغيل خادم Codeymn داخل WSL على Windows.",
  ...
  "settings.general.row.language.description": "تغيير لغة العرض لـ Codeymn",
  ...
  "settings.general.row.appearance.description": "تخصيص كيفية ظهور Codeymn على جهازك",
  "settings.general.row.colorScheme.title": "مخطط الألوان",
  "settings.general.row.colorScheme.description": "اختر ما إذا كان Codeymn يتبع سمة النظام أو الفاتح أو الداكن",
  "settings.general.row.theme.title": "السمة",
  "settings.general.row.theme.description": "تخصيص سمة Codeymn.",
  ...
  "settings.updates.row.startup.description": "التحقق تلقائيًا من التحديثات عند تشغيل Codeymn",
  ...
  "settings.updates.toast.latest.description": "أنت تستخدم أحدث إصدار من Codeymn.",
