...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Kostenlose Modelle von Codeymn",
  ...
  "provider.connect.apiKey.description":
    "Geben Sie Ihren {{provider}} API-Schlüssel ein, um Ihr Konto zu verbinden und {{provider}} Modelle in Codeymn zu nutzen.",
  ...
  "provider.connect.opencodeZen.line1":
    "Codeymn Zen bietet Ihnen Zugriff auf eine kuratierte Auswahl zuverlässiger, optimierter Modelle für Coding-Agenten.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", um Ihren Autorisierungscode zu erhalten, Ihr Konto zu verbinden und {{provider}} Modelle in Codeymn zu nutzen.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " und geben Sie den untenstehenden Code ein, um Ihr Konto zu verbinden und {{provider}} Modelle in Codeymn zu nutzen.",
  ...
  "dialog.server.description": "Wechseln Sie den Codeymn-Server, mit dem sich diese App verbindet.",
  ...
  "wsl.onboarding.step.opencode": "Codeymn",
  ...
  "wsl.onboarding.checkingOpencode": "Codeymn wird geprüft...",
  "wsl.onboarding.checkingOpencodeIn": "Codeymn in {{distro}} wird geprüft...",
  "wsl.onboarding.updatingOpencode": "Codeymn wird aktualisiert...",
  "wsl.onboarding.updatingOpencodeIn": "Codeymn in {{distro}} wird aktualisiert...",
  "wsl.onboarding.updateOpencodeIn": "Aktualisieren Sie Codeymn in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Codeymn aktualisieren",
  "wsl.onboarding.opencodeReadyIn": "Codeymn ist in {{distro}} bereit.",
  "wsl.onboarding.opencodeReady": "Codeymn ist bereit.",
  "wsl.onboarding.installOpencodeIn": "Installieren Sie Codeymn in {{distro}}.",
  "wsl.onboarding.installOpencode": "Codeymn installieren",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Codeymn nicht installiert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) ist erforderlich, bevor Codeymn einen WSL-Server hinzufügen kann",
  "wsl.onboarding.wslUnavailable.title": "WSL nicht verfügbar",
  "wsl.onboarding.wslUnavailable.description": "Codeymn konnte WSL auf diesem Computer nicht überprüfen.",
  "wsl.onboarding.installWsl": "WSL installieren",
  "wsl.onboarding.windowsRestartRequired":
    "Starten Sie Windows neu, um die WSL-Installation abzuschließen, und öffnen Sie dann Codeymn erneut.",
  ...
  "toast.update.description": "Eine neue Version von Codeymn ({{version}}) ist zur Installation verfügbar.",
  ...
  "error.page.report.prefix": "Bitte melden Sie diesen Fehler dem Codeymn-Team",
  ...
  "error.chain.mcpFailed":
    'MCP-Server "{{name}}" fehlgeschlagen. Hinweis: Codeymn unterstützt noch keine MCP-Authentifizierung.',
  ...
  "sidebar.gettingStarted.line1": "Codeymn enthält kostenlose Modelle, damit Sie sofort loslegen können.",
  ...
  "app.name.desktop": "Codeymn Desktop",
  ...
  "settings.desktop.wsl.description": "Codeymn-Server innerhalb von WSL unter Windows ausführen.",
  ...
  "settings.general.row.language.description": "Die Anzeigesprache für Codeymn ändern",
  ...
  "settings.general.row.appearance.description": "Anpassen, wie Codeymn auf Ihrem Gerät aussieht",
  "settings.general.row.colorScheme.title": "Farbschema",
  "settings.general.row.colorScheme.description":
    "Wählen Sie, ob Codeymn dem System-, hellen oder dunklen Thema folgt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Das Thema von Codeymn anpassen.",
  ...
  "settings.updates.row.startup.description": "Beim Start von Codeymn automatisch nach Updates suchen",
  ...
  "settings.updates.toast.latest.description": "Du verwendest die aktuelle Version von Codeymn.",
