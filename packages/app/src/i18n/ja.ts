export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Codeymnが提供する無料モデル",
  ...
  "provider.connect.apiKey.description":
    "{{provider}}のAPIキーを入力してアカウントを接続し、Codeymnで{{provider}}モデルを使用します。",
  ...
  "provider.connect.opencodeZen.line1":
    "Codeymn Zenは、コーディングエージェント向けに最適化された信頼性の高いモデルへのアクセスを提供します。",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " にアクセスして認証コードを取得し、アカウントを接続してCodeymnで{{provider}}モデルを使用してください。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " にアクセスし、以下のコードを入力してアカウントを接続し、Codeymnで{{provider}}モデルを使用してください。",
  ...
  "dialog.server.description": "このアプリが接続するCodeymnサーバーを切り替えます。",
  ...
  "wsl.onboarding.checkingOpencode": "Codeymnを確認中...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}}内のCodeymnを確認中...",
  "wsl.onboarding.updatingOpencode": "Codeymnを更新中...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}}内のCodeymnを更新中...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}}内のCodeymnを更新してください。",
  "wsl.onboarding.updateOpencode": "Codeymnを更新",
  "wsl.onboarding.opencodeReadyIn": "{{distro}}内のCodeymnの準備ができました。",
  "wsl.onboarding.opencodeReady": "Codeymnの準備ができました。",
  "wsl.onboarding.installOpencodeIn": "{{distro}}にCodeymnをインストールしてください。",
  "wsl.onboarding.installOpencode": "Codeymnをインストール",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Codeymnがインストールされていません",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "CodeymnでWSLサーバーを追加するには、WSL (Windows Subsystem for Linux) が必要です",
  ...
  "wsl.onboarding.windowsRestartRequired":
    "WSLのインストールを完了するにはWindowsを再起動し、Codeymnをもう一度開いてください。",
  ...
  "toast.update.description": "Codeymnの新しいバージョン ({{version}}) がインストール可能です。",
  ...
  "error.page.report.prefix": "このエラーをCodeymnチームに報告してください: ",
  ...
  "error.chain.mcpFailed": 'MCPサーバー "{{name}}" が失敗しました。注意: CodeymnはまだMCP認証をサポートしていません。',
  ...
  "sidebar.gettingStarted.line1": "Codeymnには無料モデルが含まれているため、すぐに開始できます。",
  ...
  "settings.desktop.wsl.description": "WindowsのWSL環境でCodeymnサーバーを実行します。",
  ...
  "settings.general.row.language.description": "Codeymnの表示言語を変更します",
  ...
  "settings.general.row.appearance.description": "デバイスでのCodeymnの表示をカスタマイズします",
  "settings.general.row.colorScheme.title": "配色",
  "settings.general.row.colorScheme.description": "Codeymnがシステム、ライト、またはダークテーマに従うかを選択します",
  "settings.general.row.theme.title": "テーマ",
  "settings.general.row.theme.description": "Codeymnのテーマをカスタマイズします。",
  ...
  "settings.updates.row.startup.description": "Codeymn の起動時に自動でアップデートを確認します",
  ...
  "settings.updates.toast.latest.description": "Codeymn は最新バージョンです。",
