export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje Codeymn",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u Codeymn-u.",
  ...
  "provider.connect.opencodeZen.line1":
    "Codeymn Zen ti daje pristup kuriranom skupu pouzdanih, optimizovanih modela za coding agente.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u Codeymn-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u Codeymn-u.",
  ...
  "dialog.server.description": "Promijeni na koji se Codeymn server ova aplikacija povezuje.",
  ...
  "wsl.onboarding.checkingOpencode": "Provjera Codeymn...",
  "wsl.onboarding.checkingOpencodeIn": "Provjera Codeymn u distribuciji {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Ažuriranje Codeymn...",
  "wsl.onboarding.updatingOpencodeIn": "Ažuriranje Codeymn u distribuciji {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Ažuriraj Codeymn u distribuciji {{distro}}.",
  "wsl.onboarding.updateOpencode": "Ažuriraj Codeymn",
  "wsl.onboarding.opencodeReadyIn": "Codeymn je spreman u distribuciji {{distro}}.",
  "wsl.onboarding.opencodeReady": "Codeymn je spreman.",
  "wsl.onboarding.installOpencodeIn": "Instaliraj Codeymn u distribuciji {{distro}}.",
  "wsl.onboarding.installOpencode": "Instaliraj Codeymn",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Codeymn nije instaliran",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) je potreban da bi Codeymn mogao dodati WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL nije dostupan",
  "wsl.onboarding.wslUnavailable.description": "Codeymn nije mogao provjeriti WSL na ovom uređaju.",
  "wsl.onboarding.installWsl": "Instaliraj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Ponovo pokreni Windows da završiš instalaciju WSL-a, zatim ponovo otvori Codeymn.",
  ...
  "toast.update.description": "Nova verzija Codeymn-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku Codeymn timu",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: Codeymn još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "Codeymn uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni Codeymn server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u Codeymn-u",
  ...
  "settings.general.row.appearance.description": "Prilagodi kako Codeymn izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li Codeymn prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu Codeymn-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se Codeymn pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju Codeymn-a.",
