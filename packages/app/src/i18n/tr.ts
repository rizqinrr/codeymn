...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Codeymn tarafından sunulan ücretsiz modeller",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve Codeymn'da {{provider}} modellerini kullanmak için API anahtarınızı girin.",
  ...
  "provider.connect.opencodeZen.line1":
    "Codeymn Zen, kodlama ajanları için seçilmiş güvenilir optimize edilmiş modellere erişim sağlar.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " gidin; ardından hesabınızı bağlayarak Codeymn'da {{provider}} modellerini kullanın.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak Codeymn'da {{provider}} modellerini kullanın.",
  ...
  "dialog.server.description": "Bu uygulamanın hangi Codeymn sunucusuna bağlanacağını değiştirin.",
  ...
  "wsl.onboarding.checkingOpencode": "Codeymn kontrol ediliyor...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}} içinde Codeymn kontrol ediliyor...",
  "wsl.onboarding.updatingOpencode": "Codeymn güncelleniyor...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}} içinde Codeymn güncelleniyor...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}} içindeki Codeymn'u güncelleyin.",
  "wsl.onboarding.updateOpencode": "Codeymn'u güncelle",
  "wsl.onboarding.opencodeReadyIn": "{{distro}} içinde Codeymn hazır.",
  "wsl.onboarding.opencodeReady": "Codeymn hazır.",
  "wsl.onboarding.installOpencodeIn": "Codeymn'u {{distro}} içine kurun.",
  "wsl.onboarding.installOpencode": "Codeymn'u kur",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Codeymn kurulu değil",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Codeymn'un WSL sunucusu ekleyebilmesi için önce WSL (Linux için Windows Alt Sistemi) kurulmalıdır",
  "wsl.onboarding.wslUnavailable.title": "WSL kullanılamıyor",
  "wsl.onboarding.wslUnavailable.description": "Codeymn bu makinede WSL'yi doğrulayamadı.",
  "wsl.onboarding.installWsl": "WSL'yi kur",
  "wsl.onboarding.windowsRestartRequired":
    "WSL kurulumunu tamamlamak için Windows'u yeniden başlatın, ardından Codeymn'u tekrar açın.",
  ...
  "toast.update.description": "Codeymn'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı Codeymn ekibine bildirin",
  ...
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" başarısız oldu. Not: Codeymn henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "sidebar.gettingStarted.line1": "Codeymn ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "app.name.desktop": "Codeymn Masaüstü",
  ...
  "settings.desktop.wsl.description": "Codeymn sunucusunu Windows'ta WSL içinde çalıştırın.",
  ...
  "settings.general.row.language.description": "Codeymn'un görünüm dilini değiştirin",
  ...
  "settings.general.row.appearance.description": "Codeymn'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.colorScheme.title": "Renk şeması",
  "settings.general.row.colorScheme.description":
    "Codeymn'un sistem, açık veya koyu temayı takip etip etmeyeceğini seçin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Codeymn'un temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "Codeymn başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "Codeymn'un en son sürümünü kullanıyorsunuz.",
