export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af Codeymn",
  ...
  "provider.connect.apiKey.description":
    "Indtast din {{provider}} API-nøgle for at forbinde din konto og bruge {{provider}} modeller i Codeymn.",
  ...
  "provider.connect.opencodeZen.line1":
    "Codeymn Zen giver dig adgang til et udvalg af pålidelige optimerede modeller til kodningsagenter.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode for at forbinde din konto og bruge {{provider}} modeller i Codeymn.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge {{provider}} modeller i Codeymn.",
  ...
  "dialog.server.description": "Skift hvilken Codeymn-server denne app forbinder til.",
  ...
  "wsl.onboarding.checkingOpencode": "Tjekker Codeymn...",
  "wsl.onboarding.checkingOpencodeIn": "Tjekker Codeymn i {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Opdaterer Codeymn...",
  "wsl.onboarding.updatingOpencodeIn": "Opdaterer Codeymn i {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Opdater Codeymn i {{distro}}.",
  "wsl.onboarding.updateOpencode": "Opdater Codeymn",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Codeymn er ikke installeret",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) er påkrævet, før Codeymn kan tilføje en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er ikke tilgængelig",
  "wsl.onboarding.wslUnavailable.description": "Codeymn kunne ikke bekræfte WSL på denne maskine.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Genstart Windows for at fuldføre installationen af WSL, og åbn derefter Codeymn igen.",
  ...
  "toast.update.description": "En ny version af Codeymn ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til Codeymn-teamet",
  ...
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, Codeymn understøtter ikke MCP-godkendelse endnu.',
  ...
  "sidebar.gettingStarted.line1": "Codeymn inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.desktop.wsl.description": "Kør Codeymn-serveren inde i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for Codeymn",
  ...
  "settings.general.row.appearance.description": "Tilpas hvordan Codeymn ser ud på din enhed",
  "settings.general.row.colorScheme.title": "Farveskema",
  "settings.general.row.colorScheme.description": "Vælg om Codeymn følger systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas hvordan Codeymn er temabestemt.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når Codeymn starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af Codeymn.",
