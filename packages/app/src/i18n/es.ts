export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos proporcionados por Codeymn",
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en Codeymn.",
  ...
  "provider.connect.opencodeZen.line1":
    "Codeymn Zen te da acceso a un conjunto curado de modelos fiables optimizados para agentes de programación.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en Codeymn.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en Codeymn.",
  ...
  "dialog.server.description": "Cambiar a qué servidor de Codeymn se conecta esta app.",
  ...
  "wsl.onboarding.checkingOpencode": "Comprobando Codeymn...",
  "wsl.onboarding.checkingOpencodeIn": "Comprobando Codeymn en {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Actualizando Codeymn...",
  "wsl.onboarding.updatingOpencodeIn": "Actualizando Codeymn en {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Actualiza Codeymn en {{distro}}.",
  "wsl.onboarding.updateOpencode": "Actualizar Codeymn",
  "wsl.onboarding.opencodeReadyIn": "Codeymn está listo en {{distro}}.",
  "wsl.onboarding.opencodeReady": "Codeymn está listo.",
  "wsl.onboarding.installOpencodeIn": "Instala Codeymn en {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalar Codeymn",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Codeymn no está instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Se necesita WSL (Subsistema de Windows para Linux) para que Codeymn pueda añadir un servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL no disponible",
  "wsl.onboarding.wslUnavailable.description": "Codeymn no pudo comprobar WSL en este equipo.",
  "wsl.onboarding.installWsl": "Instalar WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicia Windows para terminar de instalar WSL y, después, vuelve a abrir Codeymn.",
  ...
  "toast.update.description": "Una nueva versión de Codeymn ({{version}}) está disponible para instalar.",
  ...
  "error.page.report.prefix": "Por favor reporta este error al equipo de Codeymn",
  ...
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota, Codeymn no soporta autenticación MCP todavía.',
  ...
  "sidebar.gettingStarted.line1": "Codeymn incluye modelos gratuitos para que puedas empezar inmediatamente.",
  ...
  "settings.desktop.wsl.description": "Ejecutar el servidor Codeymn dentro de WSL en Windows.",
  ...
  "settings.general.row.language.description": "Cambiar el idioma de visualización para Codeymn",
  ...
  "settings.general.row.appearance.description": "Personaliza cómo se ve Codeymn en tu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de color",
  "settings.general.row.colorScheme.description": "Elige si Codeymn sigue el tema del sistema, claro u oscuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de Codeymn.",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automáticamente cuando se inicia Codeymn",
  ...
  "settings.updates.toast.latest.description": "Estás usando la última versión de Codeymn.",
