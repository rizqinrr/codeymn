export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo Codeymn",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no Codeymn.",
  ...
  "provider.connect.opencodeZen.line1":
    "Codeymn Zen oferece acesso a um conjunto selecionado de modelos confiáveis otimizados para agentes de código.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no Codeymn.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no Codeymn.",
  ...
  "dialog.server.description": "Trocar para qual servidor Codeymn este aplicativo se conecta.",
  ...
  "wsl.onboarding.checkingOpencode": "Verificando o Codeymn...",
  "wsl.onboarding.checkingOpencodeIn": "Verificando o Codeymn em {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Atualizando o Codeymn...",
  "wsl.onboarding.updatingOpencodeIn": "Atualizando o Codeymn em {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Atualize o Codeymn em {{distro}}.",
  "wsl.onboarding.updateOpencode": "Atualizar o Codeymn",
  "wsl.onboarding.opencodeReadyIn": "O Codeymn está pronto em {{distro}}.",
  "wsl.onboarding.opencodeReady": "O Codeymn está pronto.",
  "wsl.onboarding.installOpencodeIn": "Instale o Codeymn em {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalar o Codeymn",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Codeymn não instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "O WSL (Windows Subsystem for Linux) é necessário para que o Codeymn possa adicionar um servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponível",
  "wsl.onboarding.wslUnavailable.description": "O Codeymn não conseguiu verificar o WSL neste computador.",
  "wsl.onboarding.installWsl": "Instalar o WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicie o Windows para concluir a instalação do WSL e abra o Codeymn novamente.",
  ...
  "toast.update.description": "Uma nova versão do Codeymn ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do Codeymn",
  ...
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: Codeymn ainda não suporta autenticação MCP.',
  ...
  "sidebar.gettingStarted.line1": "Codeymn inclui modelos gratuitos para você começar imediatamente.",
  ...
  "settings.desktop.wsl.description": "Executar o servidor Codeymn dentro do WSL no Windows.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do Codeymn",
  ...
  "settings.general.row.appearance.description": "Personalize como o Codeymn aparece no seu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de cores",
  "settings.general.row.colorScheme.description": "Escolha se o Codeymn segue o tema do sistema, claro ou escuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o Codeymn é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o Codeymn iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do Codeymn.",
