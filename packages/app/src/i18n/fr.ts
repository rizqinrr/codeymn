export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Modèles gratuits fournis par Codeymn",
  ...
  "provider.connect.apiKey.description":
    "Entrez votre clé API {{provider}} pour connecter votre compte et utiliser les modèles {{provider}} dans Codeymn.",
  ...
  "provider.connect.opencodeZen.line1":
    "Codeymn Zen vous donne accès à un ensemble sélectionné de modèles fiables et optimisés pour les agents de codage.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " pour récupérer votre code d'autorisation afin de connecter votre compte et utiliser les modèles {{provider}} dans Codeymn.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " et entrez le code ci-dessous pour connecter votre compte et utiliser les modèles {{provider}} dans Codeymn.",
  ...
  "dialog.server.description": "Changez le serveur Codeymn auquel cette application se connecte.",
  ...
  "wsl.onboarding.checkingOpencode": "Vérification d'Codeymn...",
  "wsl.onboarding.checkingOpencodeIn": "Vérification d'Codeymn dans {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Mise à jour d'Codeymn...",
  "wsl.onboarding.updatingOpencodeIn": "Mise à jour d'Codeymn dans {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Mettez à jour Codeymn dans {{distro}}.",
  "wsl.onboarding.updateOpencode": "Mettre à jour Codeymn",
  "wsl.onboarding.opencodeReadyIn": "Codeymn est prêt dans {{distro}}.",
  "wsl.onboarding.opencodeReady": "Codeymn est prêt.",
  "wsl.onboarding.installOpencodeIn": "Installez Codeymn dans {{distro}}.",
  "wsl.onboarding.installOpencode": "Installer Codeymn",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Codeymn non installé",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) est requis avant qu'Codeymn puisse ajouter un serveur WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponible",
  "wsl.onboarding.wslUnavailable.description": "Codeymn n'a pas pu vérifier WSL sur cet appareil.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Redémarrez Windows pour terminer l'installation de WSL, puis rouvrez Codeymn.",
  ...
  "toast.update.description":
    "Une nouvelle version d'Codeymn ({{version}}) est maintenant disponible pour installation.",
  ...
  "error.page.report.prefix": "Veuillez signaler cette erreur à l'équipe Codeymn",
  ...
  "error.chain.mcpFailed":
    "Le serveur MCP \"{{name}}\" a échoué. Notez qu'Codeymn ne supporte pas encore l'authentification MCP.",
  ...
  "sidebar.gettingStarted.line1":
    "Codeymn inclut des modèles gratuits pour que vous puissiez commencer immédiatement.",
  ...
  "settings.desktop.wsl.description": "Exécuter le serveur Codeymn dans WSL sur Windows.",
  ...
  "settings.general.row.language.description": "Changer la langue d'affichage pour Codeymn",
  ...
  "settings.general.row.appearance.description": "Personnaliser l'apparence d'Codeymn sur votre appareil",
  "settings.general.row.colorScheme.title": "Schéma de couleurs",
  "settings.general.row.colorScheme.description": "Choisissez si Codeymn suit le thème système, clair ou sombre",
  "settings.general.row.theme.title": "Thème",
  "settings.general.row.theme.description": "Personnaliser le thème d'Codeymn.",
  ...
  "settings.updates.row.startup.description": "Vérifier automatiquement les mises à jour au lancement d'Codeymn",
  ...
  "settings.updates.toast.latest.description": "Vous utilisez la dernière version d'Codeymn.",
