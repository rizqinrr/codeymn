...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av Codeymn",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn din {{provider}} API-nøkkel for å koble til kontoen din og bruke {{provider}}-modeller i Codeymn.",
  ...
  "provider.connect.opencodeZen.line1":
    "Codeymn Zen gir deg tilgang til et utvalg av pålitelige optimaliserte modeller for kodeagenter.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i Codeymn.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i Codeymn.",
  ...
  "dialog.server.description": "Bytt hvilken Codeymn-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av Codeymn ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til Codeymn-teamet",
  ...
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at Codeymn ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "Codeymn inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "Kjør Codeymn-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for Codeymn",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan Codeymn ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description": "Velg om Codeymn skal følge systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass hvordan Codeymn er tematisert.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når Codeymn starter",
  ...
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av Codeymn.",
  ...
  "wsl.onboarding.checkingOpencode": "Sjekker Codeymn...",
  "wsl.onboarding.checkingOpencodeIn": "Sjekker Codeymn i {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Oppdaterer Codeymn...",
  "wsl.onboarding.updatingOpencodeIn": "Oppdaterer Codeymn i {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Oppdater Codeymn i {{distro}}.",
  "wsl.onboarding.updateOpencode": "Oppdater Codeymn",
  "wsl.onboarding.opencodeReadyIn": "Codeymn er klar i {{distro}}.",
  "wsl.onboarding.opencodeReady": "Codeymn er klar.",
  "wsl.onboarding.installOpencodeIn": "Installer Codeymn i {{distro}}.",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Codeymn er ikke installert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) kreves før Codeymn kan legge til en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er utilgjengelig",
  "wsl.onboarding.wslUnavailable.description": "Codeymn kunne ikke bekrefte WSL på denne maskinen.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Start Windows på nytt for å fullføre installasjonen av WSL, og åpne deretter Codeymn på nytt.",
