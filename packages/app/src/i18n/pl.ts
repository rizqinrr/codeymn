export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez Codeymn",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w Codeymn.",
  ...
  "provider.connect.opencodeZen.line1":
    "Codeymn Zen daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów kodujących.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w Codeymn.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w Codeymn.",
  ...
  "dialog.server.description": "Przełącz serwer Codeymn, z którym łączy się ta aplikacja.",
  ...
  "wsl.onboarding.checkingOpencode": "Sprawdzanie Codeymn...",
  "wsl.onboarding.checkingOpencodeIn": "Sprawdzanie Codeymn w dystrybucji {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Aktualizowanie Codeymn...",
  "wsl.onboarding.updatingOpencodeIn": "Aktualizowanie Codeymn w dystrybucji {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Zaktualizuj Codeymn w dystrybucji {{distro}}.",
  "wsl.onboarding.updateOpencode": "Zaktualizuj Codeymn",
  "wsl.onboarding.opencodeReadyIn": "Codeymn jest gotowy w dystrybucji {{distro}}.",
  "wsl.onboarding.opencodeReady": "Codeymn jest gotowy.",
  "wsl.onboarding.installOpencodeIn": "Zainstaluj Codeymn w dystrybucji {{distro}}.",
  "wsl.onboarding.installOpencode": "Zainstaluj Codeymn",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Codeymn nie jest zainstalowany",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Podsystem Windows dla systemu Linux) jest wymagany, zanim Codeymn będzie mógł dodać serwer WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL jest niedostępny",
  "wsl.onboarding.wslUnavailable.description": "Codeymn nie mógł zweryfikować WSL na tym komputerze.",
  "wsl.onboarding.installWsl": "Zainstaluj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Uruchom ponownie system Windows, aby dokończyć instalację WSL, a następnie ponownie otwórz Codeymn.",
  ...
  "toast.update.description": "Nowa wersja Codeymn ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu Codeymn",
  ...
  "error.chain.mcpFailed":
    "Serwer MCP „{{name}}” nie uruchomił się. Uwaga: Codeymn nie obsługuje jeszcze uwierzytelniania MCP.",
  ...
  "sidebar.gettingStarted.line1": "Codeymn zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.desktop.wsl.description": "Uruchamiaj serwer Codeymn wewnątrz WSL w systemie Windows.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla Codeymn",
  ...
  "settings.general.row.appearance.description": "Dostosuj wygląd Codeymn na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy Codeymn ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw Codeymn.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania Codeymn",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji Codeymn.",
