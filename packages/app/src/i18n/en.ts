export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by Codeymn",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in Codeymn.",
  "provider.connect.apiKey.label": "{{provider}} API key",
  "provider.connect.apiKey.placeholder": "API key",
  "provider.connect.apiKey.required": "API key is required",
  "provider.connect.opencodeZen.line1":
    "Codeymn Zen gives you access to a curated set of reliable optimized models for coding agents.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in Codeymn.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in Codeymn.",
  ...
  "dialog.server.description": "Switch which Codeymn server this app connects to.",
  ...
  "wsl.onboarding.checkingOpencode": "Checking Codeymn...",
  "wsl.onboarding.checkingOpencodeIn": "Checking Codeymn in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Updating Codeymn...",
  "wsl.onboarding.updatingOpencodeIn": "Updating Codeymn in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Update Codeymn in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Update Codeymn",
  "wsl.onboarding.opencodeReadyIn": "Codeymn is ready in {{distro}}.",
  "wsl.onboarding.opencodeReady": "Codeymn is ready.",
  "wsl.onboarding.installOpencodeIn": "Install Codeymn in {{distro}}.",
  "wsl.onboarding.installOpencode": "Install Codeymn",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Codeymn not installed",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) is required before Codeymn can add a WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL unavailable",
  "wsl.onboarding.wslUnavailable.description": "Codeymn could not verify WSL on this machine.",
  "wsl.onboarding.installWsl": "Install WSL",
  "wsl.onboarding.windowsRestartRequired": "Restart Windows to finish installing WSL, then reopen Codeymn.",
  ...
  "toast.update.description": "A new version of Codeymn ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the Codeymn team",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, Codeymn does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "Codeymn includes free models so you can start immediately.",
  ...
  "settings.desktop.wsl.description": "Run the Codeymn server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for Codeymn",
  ...
  "settings.general.row.appearance.description": "Customise how Codeymn looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether Codeymn follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how Codeymn is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when Codeymn launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of Codeymn.",
