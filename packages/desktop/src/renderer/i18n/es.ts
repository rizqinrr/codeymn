export const dict = {
  ...
  "desktop.updater.none.message": "Ya estás usando la versión más reciente de Codeymn",
  ...
  "desktop.updater.downloaded.prompt":
    "Se ha descargado la versión {{version}} de Codeymn. ¿Quieres instalarla y reiniciar?",
