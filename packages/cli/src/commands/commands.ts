...
declare const CODEYMN_CLI_NAME: string | undefined

export const Commands = Spec.make(typeof CODEYMN_CLI_NAME === "string" ? CODEYMN_CLI_NAME : "opencode", {
  description: "Codeymn 2.0 preview command line interface",
  commands: [
    Spec.make("api", {
