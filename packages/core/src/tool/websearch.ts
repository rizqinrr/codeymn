...
export const defaultConfigLayer = Layer.sync(ConfigService, () =>
  ConfigService.of({
    provider:
      process.env.CODEYMN_WEBSEARCH_PROVIDER === "exa" || process.env.CODEYMN_WEBSEARCH_PROVIDER === "parallel"
        ? process.env.CODEYMN_WEBSEARCH_PROVIDER
        : undefined,
    enableExa: truthy("CODEYMN_EXPERIMENTAL") || truthy("CODEYMN_ENABLE_EXA") || truthy("CODEYMN_EXPERIMENTAL_EXA"),
    enableParallel: truthy("CODEYMN_ENABLE_PARALLEL") || truthy("CODEYMN_EXPERIMENTAL_PARALLEL"),
