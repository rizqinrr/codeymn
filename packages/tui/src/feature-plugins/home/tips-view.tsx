...
const TIPS: Tip[] = [
  ...
  "Run {highlight}/share{/highlight} to create a public shared link",
  ...
  "Create a plugin to prevent Codeymn from reading sensitive files",
  "Use {highlight}codeymn run{/highlight} for non-interactive scripting",
  "Use {highlight}codeymn --continue{/highlight} to resume the last session",
  "Use {highlight}codeymn run -f file.ts{/highlight} to attach files via CLI",
  "Use {highlight}--format json{/highlight} for machine-readable output in scripts",
  "Run {highlight}codeymn serve{/highlight} for headless API access to Codeymn",
  "Use {highlight}codeymn run --attach{/highlight} to connect to a running server",
  "Run {highlight}codeymn upgrade{/highlight} to update to the latest version",
  "Run {highlight}codeymn auth list{/highlight} to see all configured providers",
  "Run {highlight}codeymn agent create{/highlight} for guided agent creation",
  "Use {highlight}/codeymn{/highlight} in GitHub issues/PRs to trigger AI actions",
  "Run {highlight}codeymn github install{/highlight} to set up the GitHub workflow",
  "Comment {highlight}/codeymn fix this{/highlight} on issues to auto-create PRs",
  ...
  "Run {highlight}codeymn debug config{/highlight} to troubleshoot configuration",
  ...
  "Run {highlight}docker run -it --rm ghcr.io/anomalyco/codeymn{/highlight} in a container",
  "Use {highlight}/connect{/highlight} with Codeymn Zen for curated, tested models",
